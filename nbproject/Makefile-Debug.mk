...
# CC Compiler Flags
CCFLAGS=--std=c++17 -pthread -lboost_unit_test_framework
CXXFLAGS=--std=c++17 -pthread -lboost_unit_test_framework
...
${OBJECTDIR}/src/distance-calculator.o: src/distance-calculator.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/distance-calculator.o src/distance-calculator.cpp

${OBJECTDIR}/src/main.o: src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp

${OBJECTDIR}/src/point-of-interest.o: src/point-of-interest.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/point-of-interest.o src/point-of-interest.cpp
...
${TESTDIR}/tests/distance-calculator.test.o: tests/distance-calculator.test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Isrc -I. --std=c++17 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/distance-calculator.test.o tests/distance-calculator.test.cpp


${TESTDIR}/tests/main.test.o: tests/main.test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Isrc -I. --std=c++17 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/main.test.o tests/main.test.cpp


${TESTDIR}/tests/point-of-interest.test.o: tests/point-of-interest.test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Isrc -I. --std=c++17 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/point-of-interest.test.o tests/point-of-interest.test.cpp
...
${OBJECTDIR}/src/distance-calculator_nomain.o: ${OBJECTDIR}/src/distance-calculator.o src/distance-calculator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/distance-calculator_nomain.o src/distance-calculator.cpp;\
	else  \
...
${OBJECTDIR}/src/main_nomain.o: ${OBJECTDIR}/src/main.o src/main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main_nomain.o src/main.cpp;\
	else  \
...
${OBJECTDIR}/src/point-of-interest_nomain.o: ${OBJECTDIR}/src/point-of-interest.o src/point-of-interest.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/point-of-interest_nomain.o src/point-of-interest.cpp;\
	else  \
